...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'App.appkey'
        db.add_column(u'apps_app', 'appkey',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'App.uploaded'
        db.add_column(u'apps_app', 'uploaded',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'App.appkey'
        db.delete_column(u'apps_app', 'appkey')

        # Deleting field 'App.uploaded'
        db.delete_column(u'apps_app', 'uploaded')
