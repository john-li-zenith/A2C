...
class Contact(models.Model):
    ...
    license_scan_hand=models.ImageField(upload_to='account/license/%Y/%m/%d',null=True,help_text='In JPG or PNG format. Color scans preferred. For black and white license, please also upload below a copy with a COLORED stamp.')
    license_scan_stamp=models.ImageField(upload_to='account/license/%Y/%m/%d',null=True,help_text='In JPG or PNG format. In China, all business licenses have a red stamp of approval by the government. Some stores also expect foreign licenses to have some form of approval "stamp" on the business license. For black and white license, please stamp the license with COLORED company stamp.')
    ...
    passport_scan_hand=models.ImageField(upload_to='account/passport/%Y/%m/%d',null=True,help_text='In JPG or PNG format. Some app stores require the scan to show a hand holding the passport.')
