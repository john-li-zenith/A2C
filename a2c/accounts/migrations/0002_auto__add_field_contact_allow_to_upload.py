...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.allow_to_upload'
        db.add_column(u'accounts_contact', 'allow_to_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.allow_to_upload'
        db.delete_column(u'accounts_contact', 'allow_to_upload')
