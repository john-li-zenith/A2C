...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_contact', (
            ...
            ('license_scan_hand', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('license_scan_stamp', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('passport', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('passport_scan', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('passport_scan_hand', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('street', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('state', self.gf('localflavor.us.models.USStateField')(max_length=2, null=True)),
            ('zipcode', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
    ...
    models = {
        u'accounts.contact': {
            ...
            'license_scan_hand': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            'license_scan_stamp': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            'nickname': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'passport': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'passport_scan': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            'passport_scan_hand': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
