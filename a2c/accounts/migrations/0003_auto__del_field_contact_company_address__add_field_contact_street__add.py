...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.company_address'
        db.delete_column(u'accounts_contact', 'company_address')

        # Adding field 'Contact.street'
        db.add_column(u'accounts_contact', 'street',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Contact.zipcode'
        db.add_column(u'accounts_contact', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Contact.city'
        db.add_column(u'accounts_contact', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Contact.country'
        db.add_column(u'accounts_contact', 'country',
                      self.gf('django_countries.fields.CountryField')(max_length=2, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contact.company_address'
        db.add_column(u'accounts_contact', 'company_address',
                      self.gf('django.db.models.fields.CharField')(default='removed', max_length=100),
                      keep_default=False)

        # Deleting field 'Contact.street'
        db.delete_column(u'accounts_contact', 'street')

        # Deleting field 'Contact.zipcode'
        db.delete_column(u'accounts_contact', 'zipcode')

        # Deleting field 'Contact.city'
        db.delete_column(u'accounts_contact', 'city')

        # Deleting field 'Contact.country'
        db.delete_column(u'accounts_contact', 'country')
